...
- Uploaded MIDI files and generated WAV files are temporary files under `/tmp`; the compose file mounts `/tmp` as an in-memory tmpfs and no upload data is persisted.
